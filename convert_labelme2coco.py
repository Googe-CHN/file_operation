...
#0为背景
classname_to_id = {"weironghe": 1, "hanliu": 2, "lieweng": 3, "aokeng": 4}
...
if __name__ == '__main__':
    ...
    labelme_path = '/home/birl/data/manvjie/datasets/labelme_jpg'

    train_img_out_path='./datasets/train2014'
    val_img_out_path = './datasets/val2014'
    ...
    l2c_train.save_coco_json(train_instance, 'instances_train2014.json')
 
    # 把验证集转化为COCO的json格式
    l2c_val = Lableme2CoCo()
    val_instance = l2c_val.to_coco(val_path)
    l2c_val.save_coco_json(val_instance, 'instances_val2014.json')
